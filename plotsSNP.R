...
a = read.table("/home/cicconella/DadosMestrado/intensity-snp")
...
plot(t(a[1:2,-1]), xlab = "Allele A", ylab = "Allele B", pch = 16, col = rgb(0,0,1, alpha = 0.5), 
     main = "Allele intensities of SNP_A-4265735")

r = a[1,-1]+a[2,-1]
r[1:5]
r = as.numeric(r)

t = (atan(a[1,-1]/a[2,-1]))/(pi/2)
t[1:5]
t = as.numeric(t)

plot(r,t, xlab = "R", ylab = expression(theta), pch = 16, col = rgb(0,0,1, alpha = 0.5), 
     main = ("Polar coordinates of SNP_A-4265735 intensities"))
